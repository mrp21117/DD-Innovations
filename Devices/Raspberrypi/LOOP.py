...
try:
    ...
    while(1):
        ...
        # command to read digital inputs (Modbus RTU frame or custom protocol)
        ...
        #command to turn on/off individual digital outputs (Modbus RTU frame or custom protocol)
